...
import { createInvoice as createInvoiceFunc, updateInvoice as updateInvoiceFunc, deleteInvoice as deleteInvoiceFunc } from '@/lib/services/invoice.service.func';
...
export async function createInvoice(formData: FormData) {
  try {
    ...
    const processedData = {
      ...
      invoice_items: invoiceData.invoice_items ? JSON.parse(invoiceData.invoice_items as string) : [],
    };
...
export async function updateInvoice(id: string, formData: FormData) {
  try {
    ...
    const processedUpdates = {
      ...
      invoice_items: updates.invoice_items ? JSON.parse(updates.invoice_items as string) : undefined,
    };
