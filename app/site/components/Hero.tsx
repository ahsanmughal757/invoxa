    ...
    <section className="relative pt-32 pb-20 lg:pt-56 lg:pb-40 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="inline-flex items-center space-x-2 px-4 py-2 bg-indigo-500/10 border border-indigo-500/20 rounded-full mb-10 transition-transform hover:scale-105 cursor-default">
          ...
          <span className="text-sm font-bold text-indigo-300 uppercase tracking-[0.2em]">The Gold Standard Invoicing</span>
        </div>

        <h1 className="text-6xl md:text-8xl lg:text-9xl font-extrabold text-white tracking-tighter mb-8 leading-[0.9]">
          Invoice<span className="gradient-text">Pro</span>
        </h1>
        
        <h2 className="text-3xl md:text-5xl font-bold text-slate-200 mb-8 tracking-tight max-w-4xl mx-auto">
          Enterprise Billing for the Modern Era.
        </h2>

        <p className="max-w-2xl mx-auto text-lg md:text-xl text-slate-400 mb-12 leading-relaxed">
          The ultimate financial operating system for agencies and high-growth startups. 
          Streamline accounts receivable, automate collections, and scale with confidence.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-24">
          ...
          <button className="w-full sm:w-auto px-12 py-5 bg-slate-900 text-white font-bold rounded-2xl border border-white/10 flex items-center justify-center transition-all hover:bg-slate-800 active:scale-95">
        ...
        <div className="flex flex-wrap justify-center gap-4 md:gap-8 max-w-5xl mx-auto opacity-70">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs font-semibold uppercase tracking-widest text-slate-300">SOC2 Type II Compliant</span>
          </div>
          <div className="flex items-center space-x-2">
            <Zap className="w-5 h-4 text-indigo-400" />
            <span className="text-xs font-semibold uppercase tracking-widest text-slate-300">Real-time Settlements</span>
          </div>
          <div className="flex items-center space-x-2">
            <Star className="w-5 h-4 text-indigo-400" />
            <span className="text-xs font-semibold uppercase tracking-widest text-slate-300">Rated 4.9/5 by G2</span>
          </div>
        </div>
      </div>
